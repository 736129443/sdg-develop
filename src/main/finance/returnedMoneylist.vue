<template>
    <div class="main returnedMoney">
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column  align="center" label="账单周期">
                <template  slot-scope="scope">
        ...
        >
            ...
            <span slot="footer" class="dialog-footer" >
                ...
                <el-button type="primary" @click="Submission" :loading="wait" v-if="this.info == 'off'?true:false">确 定</el-button>
                                <!--<el-button  @click="$router.push({path:'/returnedMoneylist'})" type="primary" v-if="invoiceApplyAndRecord">回款申请记录</el-button>-->
            </span>
        </el-dialog>
        <el-dialog
                title="账单时间"
        ...
        methods:{
            ajax(){
                let page = JSON.stringify({
                    token:this.token,
                    "conditionStr7": "repayapplylist",          //带权限的标示
